...
const certificates = [
    ...
    { id: 9, title: "Network Defense Essentials", organization: "EC-Council", date: "July 2023", category: "Ethical Hacking", level: "Beginner", color: "#ff0080", icon: "🛡️", link: "https://learn.eccouncil.org/certificate/1d600f04-fd3b-43e4-a9c6-3c3e416fb98b", skills: ["Network Security", "Defense Strategies"], description: "Network defense fundamentals" },
    { id: 10, title: "SQL Injection Attacks", organization: "EC-Council", date: "Jan 2023", category: "Web Security", level: "Intermediate", color: "#00ff80", icon: "🔒", link: "https://learn.eccouncil.org/certificate/98bff0f6-6b2c-45b0-907b-5f710e194dbf", skills: ["SQL Security", "Web Attacks"], description: "SQL injection techniques and prevention" },
    ...
    { id: 13, title: "Young Turks", organization: "Naukri Campus", date: "Oct 2024", category: "Programming", level: "Beginner", color: "#ffff00", icon: "🚀", link: "https://www.naukri.com/campus/certificates/young_turks_round_1_achievement/v0/6707e9bc5abe131f423e1f97", skills: ["Career Development", "Professional Skills"], description: "Professional development and career advancement program" },
